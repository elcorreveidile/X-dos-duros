...
export const metadata: Metadata = {
  title: 'Agencia Web en Sevilla — Tu web lista en 48 horas | Por 2 Duros',
  description:
  ...
  openGraph: {
    ...
    url: 'https://por2duros.com/agencia-web-sevilla',
...
const localBusinessSchema = {
  ...
  name: 'Por 2 Duros — Agencia Web Sevilla',
  description: 'Agencia de desarrollo web en Sevilla especializada en webs, landing pages, tiendas online y MVPs en 48 horas.',
  url: 'https://por2duros.com/agencia-web-sevilla',
...
const faqSchema = {
  ...
  mainEntity: [
    {
      '@type': 'Question',
      name: '¿Hacéis webs para negocios de Sevilla?',
      acceptedAnswer: { '@type': 'Answer', text: 'Sí. Trabajamos con negocios de Sevilla y toda la provincia. Trabajamos en remoto con la misma calidad que en persona: videollamada de briefing, prototipo en 24h y entrega en 48h.' },
    },
    {
      '@type': 'Question',
      name: '¿Cuánto cuesta una web en Sevilla?',
...
export default function AgenciaWebSevillaPage() {
  return (
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 grid-bg overflow-hidden">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 border border-neon/40 bg-neon/5 px-4 py-2 mb-8">
              ...
              <span className="text-neon text-xs uppercase tracking-widest font-mono">Agencia Web · Sevilla</span>
            </div>
            ...
            <p className="text-muted text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
              Desarrollamos webs, landing pages, tiendas online y MVPs para negocios de Sevilla y toda la provincia.
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
          <div className="max-w-5xl mx-auto">
            <h2 className="section-title text-center mb-4">Servicios web en Sevilla</h2>
            <p className="section-subtitle text-center mx-auto mb-12">
              Todo lo que necesita tu negocio sevillano para tener presencia digital profesional.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
          <div className="max-w-4xl mx-auto">
            <h2 className="section-title text-center mb-4">Por qué elegirnos para tu web en Sevilla</h2>
            <p className="section-subtitle text-center mx-auto mb-12">
              Sevilla es la capital económica de Andalucía. Tu negocio necesita una web que esté a la altura.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                ...
                { title: 'Escala rápido', desc: 'Sevilla es la capital económica de Andalucía. Tu web tiene que estar a la altura de una ciudad que no para de crecer.' },
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-black uppercase tracking-tighter mb-4">
              ¿Tu negocio en Sevilla necesita una web?
            </h2>
