    ...
    <div className="min-h-screen bg-[#0A0A0A] flex flex-col items-center justify-center px-4 py-12 font-mono">
      <div className="w-full max-w-sm border border-[#39FF14]/30 bg-[#111] shadow-[0_0_40px_rgba(57,255,20,0.08)]">
        ...
        <div className="p-6 space-y-3">
          <a href="tel:+34690026370" className="flex items-center gap-4 p-3 border border-[#222] hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all group">
          ...
          <a href="https://wa.me/34690026370" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-3 border border-[#222] hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all group">
          ...
          <a href="mailto:informa@blablaele.com" className="flex items-center gap-4 p-3 border border-[#222] hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all group">
          ...
          <a href="https://laclasedigital.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-3 border border-[#222] hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all group">
        ...
        <div className="px-6 pb-4 flex gap-3">
          <a href="https://www.instagram.com/clasedigitalizada/" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 p-3 border border-[#222] hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all group">
          ...
          <a href="https://www.youtube.com/@blablaELE" target="_blank" rel="noopener noreferrer" className="flex-1 flex items-center justify-center gap-2 p-3 border border-[#222] hover:border-[#39FF14]/40 hover:bg-[#39FF14]/5 transition-all group">
        ...
        <div className="px-6 pb-6 space-y-3">
          <a href="/laclasedigital/vcard" download className="flex items-center justify-center gap-2 w-full py-3 bg-[#39FF14] text-[#0A0A0A] font-black text-xs uppercase tracking-widest hover:bg-[#39FF14]/90 transition-colors">
            <Download size={14} />
            Añadir a contactos
          </a>
          <button onClick={handleShare} className="flex items-center justify-center gap-2 w-full py-3 border border-[#39FF14]/40 text-[#39FF14] font-bold text-xs uppercase tracking-widest hover:bg-[#39FF14]/5 transition-colors">
            <Share2 size={14} />
            Compartir tarjeta
          </button>
        </div>
