...
export const metadata: Metadata = {
  title: 'Agencia Web en Granada — Tu web lista en 48 horas | Por 2 Duros',
  description:
    'Agencia de desarrollo web en Granada. Webs, landing pages, tiendas online y MVPs desde €299. Código a medida, sin plantillas, entrega en 48 horas garantizada.',
  keywords: ['agencia web Granada', 'diseño web Granada', 'desarrollo web Granada', 'páginas web Granada', 'crear web Granada'],
  openGraph: {
    title: 'Agencia Web en Granada — Tu web lista en 48 horas',
    description: 'Desarrollo web profesional en Granada. Desde €299, entrega en 48 horas, código a medida.',
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: { '@type': 'Answer', text: 'Sí. Trabajamos con negocios de Granada y toda la provincia. Trabajamos en remoto con la misma calidad que en persona: videollamada de briefing, prototipo en 24h y entrega en 48h.' },
    },
    {
      '@type': 'Question',
  ...
  return (
    <>
      ...
      <main className="pt-16">
        ...
        <section className="relative py-24 px-4 sm:px-6 lg:px-8 grid-bg overflow-hidden">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 border border-neon/40 bg-neon/5 px-4 py-2 mb-8">
              ...
              <span className="text-neon text-xs uppercase tracking-widest font-mono">Agencia Web · Granada</span>
            </div>
            ...
            <p className="text-muted text-lg max-w-2xl mx-auto mb-10 leading-relaxed">
              Desarrollamos webs, landing pages, tiendas online y MVPs para negocios de Granada y provincia.
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="section-subtitle text-center mx-auto mb-12">
              Todo lo que necesita tu negocio granadino para tener presencia digital profesional.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border">
          <div className="max-w-4xl mx-auto">
            <h2 className="section-title text-center mb-4">Por qué elegirnos para tu web en Granada</h2>
            <p className="section-subtitle text-center mx-auto mb-12">
              Granada es una ciudad con mucho talento y mucha competencia. Tu web tiene que destacar.
            </p>
        ...
        <section className="py-20 px-4 sm:px-6 lg:px-8 border-t border-border text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-black uppercase tracking-tighter mb-4">
              ¿Tu negocio en Granada necesita una web?
            </h2>
